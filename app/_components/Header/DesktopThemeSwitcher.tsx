...
const DesktopThemeSwitcher = () => {
  ...
  return (
    <>
      <button onClick={handleClick} className='hidden sm:flex items-center justify-end gap-4 text-[var(--foreground)] cursor-pointer hover:text-[var(--color-primary-hover)]'>
